...
export default async function (page: Page) {
    ...
    class ProductPage extends React.Component<{ product: Product }, ProductPageState>{
        ...
        render() {
            ...
            return (
                <PageComponent>
                    <PageHeader style={{ position: 'fixed' }} ref={(o) => this.header = o || this.header}>
                    ...
                    <PageView ref={(o) => this.productView = o || this.productView} className="main"
                        pullUpIndicator={{
                    ...
                    <PageView ref={(o) => this.introduceView = o || this.introduceView}
                    ...
                    <ProductPanel ref={(o) => this.productPanel = o || this.productPanel} parent={this} product={this.props.product} />
                </PageComponent>
